...
export const Ruler = () => {
  ...
  const handleLeftDoubleClick = () => {
    setLeftMargin(MINIMUN_SPACE);
  };

  const handleRightDoubleClick = () => {
    setRightMargin(MINIMUN_SPACE);
  };
            ...
            {markers.map((marker) => {
              ...
              return (
                ...
                >
                  {marker % 10 === 0 && (
                    <>
                      <div className="absolute bottom-0 w-px h-2 bg-neutral-500"></div>
                  ...
                  {marker % 5 !== 0 && (
                    <div className="absolute bottom-0 w-px h-1 bg-neutral-500"></div>
                  )}
                </div>
              );
            })}
